...
| [decisions/](decisions/) | Decisões adicionais | Decisões arquiteturais além dos documentos principais, incluindo execução, adaptação externa e composição operacional. | Verifique antes de decisões arquiteturais; há decisões registradas de `0001` a `0004`. |
